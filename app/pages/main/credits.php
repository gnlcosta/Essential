...
$credits[] = array('en' => 0, 'title' => 'Snap7', 'desc' => '<a href="http://snap7.sourceforge.net/" title="Snap7">Snap7</a> is an open source, 32/64 bit, multi-platform Ethernet communication suite for interfacing natively with Siemens S7 PLCs. Licensed under the Lesser General Public License version 3.0');
...
$attributions = array();
$attributions[] = array('en' => 0, 'title' => 'GeoLite databases', 'desc' => 'This product includes GeoLite data created by MaxMind, available from <a href="http://www.maxmind.com">http://www.maxmind.com</a>');
...
foreach ($credits as $credit):
	...
	<?php endif?>
	<?php if ($credit['en']): $i++; ?>
	<div class="col-md-4 <?php echo $cls;?>">
		<div class="">
...
foreach ($attributions as $attribution):
	...
	<div class="col-md-6 <?php echo $cls;?>">
		<div class="">
